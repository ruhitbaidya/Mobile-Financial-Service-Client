      ...
      <div className="w-[60%] mx-auto h-full  flex justify-center items-center">
        <div className=" w-full p-[50px] reg-bg">
          ...
          <form onSubmit={handelSubmit}>
            <div>
              <h2 className="text-center text-[40px] font-[700] text-white">Login</h2>
            </div>
            <div className="space-y-5">
              <div>
                <label className="text-white" htmlFor="">Enter Your Phone Or Email</label>
                <input
                  name="user"
              ...
              <div>
                <label className="text-white" htmlFor="">Enter Your pin</label>
                <input
                  name="pin"
                  className="w-full p-[10px] rounded-lg"
                  type="password"
